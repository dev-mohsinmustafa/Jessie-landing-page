  ...
  return (
    ...
    <div className=''>
      ...
      <div className=' flex flex-col  items-end    '>       {/* mr-20 deleted*/}
        ...
        <div className=" md:w-1/2 mt-[320px] md:mt-[151px]">
          <div className="flex flex-col items-start text-left mb-6  md:mb-3   mr-0 sm:mr-[100px]  ">
              ...
              <p className="max-w-lg text-[#EEEEEE] font-[Poppins] font-normal px-3 md:px-0 text-[16px] leading-[30px] tracking-[4%]">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint.
      ...
      <div className=''>
        ...
        <div className='flex px-5 md:px-0  md:ml-20 flex-row items-center '>
      ...
      <div className='flex flex-row items-center px-5 md:px-0  md:ml-20 gap-3 '>
    ...
    <img src={image} alt="" className='absolute top-0 -z-50' />
    </div>
  )
}
